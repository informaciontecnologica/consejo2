...
<html>
 ...
 <!--<div class="row" ng-show="ListaProvincial">-->
                        ...
                        <form class="navbar-form navbar-left">
                            <div class="form-group">
                                <label class="form-inline">
                                    <input type="text" ng-model="searchprovincial" class="form-control" placeholder="Filtrar"/>
                                </label>
                ...
                <div class="tg-wrap">
                    <table id="tg-ezXJz" class="tg">
                        <caption class="text-center">Lista de Despachos Provinciales</caption>
                        <thead>
                            <tr>
                        ...
                        <tbody ng-repeat="fe in provincial| filter:searchprovincial  | startFromGrid: currentPage * pageSize | limitTo: pageSize">
                            <tr>
                                <td>{{$index + 1}}</td>
                                <td>{{tribunales[fe.idlugar - 1].nombre}}</td>
                                <td>{{fe.fecha| date:'dd-MM-yyyy'}}</td>
                                <td><a ng-href="../despachos/provincial/{{fe.nombrearchivo}}" target="top" title="Ver" class="glyphicon glyphicon-edit"></a></td>
                                <td> <button ng-click="BorrarProvincial(fe.idprovincial)" title="Borrar"class="glyphicon glyphicon-remove pull-right"></button></td>
                            </tr>

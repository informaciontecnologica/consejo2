...
<html>
    ...
    <body>
        <h4>Juzgado Civil</h4>
        <form name="federal" method="post" action="" >
            ...
            <select name="idlugar" id="idlugar" style="font-size:18px;">
                ...
                <option value="3">Tribunal 1</option>
                <option value="4">Tribunal 2</option>
...
if (isset($_POST['idlugar'])) {
    ...
    $cadena2 = "SELECT * FROM federal WHERE fecha=:fecha and idlugar=:idlugar";
    ...
    if ($consulta->rowCount() > 0) {
        while ($registro = $consulta->fetch(PDO::FETCH_ASSOC)) {
            header("location:../despachos/federal/" . $registro['nombrearchivo']);
        }
    } else {

...
//        echo $fecha;
    ...
    function ListaProvincial() {
        $pdo3 = new conexion();
        $cadena2 = "select * from provincial order by fecha Desc ";
        $consulta = $pdo3->prepare($cadena2);
        $consulta->execute();
        if ($consulta->rowCount() > 0) {
            ...
            return json_encode(array("provincial" => $rows));
        } else {
            return json_encode(array("provincial" => "false"));
        }
    }
